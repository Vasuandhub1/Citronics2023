...
import "./enterprenureship.css"
import bg from "./Entrepreneurship.jpg"
import { NavLink } from "react-router-dom";
import amount_context from "../../../context/context";
export default function Enterprenurship() {
  ...
  //handeling the event in button click
  ...
  <div id="comp">
    ...
    {window.outerWidth<=768?<div id="main">
        ...
        <h2 className="heading">Enterprenureship Events</h2>
        </div> : <div id ="main-pc" >
        <img src={img} alt="error" id="img"/>
        <h1 className="heading-pc">Chameli Devi Group Of Institutions</h1>
        <h2 className="heading-pc">CITRONICS - 2K24</h2>
        <h2 className="heading-pc">Enterprenureship Events</h2>
        </div>}
        </div>
        <div id="sec-com">
         <ul id="event">
         {data&& data.map &&data.map((elements,index)=>{
           if(elements.branch==="enterprenureship"){return(
